...
- **`docs/*-data-map.md`** — NEWAVE/DECOMP modellers, in pt-BR. Generated
  from `docs/lineage/*.toml`; the voice and durability rules apply to the TOML
  prose, and the page is never edited by hand.
...
- `docs/newave-data-map.md` and `docs/decomp-data-map.md` are generated by
  `scripts/gen-lineage-docs.py` from `docs/lineage/` and gated by
