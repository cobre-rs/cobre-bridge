...
data the shared ``newave.converters.hydro.bounds._compute_max_turbined_rated`` reads —
...
``newave.converters.hydro.bounds._compute_max_turbined_head_corrected`` — derating the
