"""Performance tab module for the Cobre dashboard.

Displays run summary metrics, training iteration breakdowns, LP solver details,
LP dimensions, scaling quality, and simulation scenario times.
"""
...
def render(data: DashboardData) -> str:
    """Return full HTML for the Performance tab.

    Includes sim_manifest filtering logic (dashboard.py lines 6654-6665):
    the solver_sim frame is trimmed to the actual number of completed simulation
