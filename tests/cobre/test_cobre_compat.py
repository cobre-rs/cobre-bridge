...
def test_supports_output_at_the_floor() -> None:
    assert _cobre_python_supports_output("0.16.0") is True


def test_supports_output_above_the_floor() -> None:
    assert _cobre_python_supports_output("0.16.1") is True


def test_supports_output_below_the_floor() -> None:
    assert _cobre_python_supports_output("0.15.0") is False


def test_supports_output_pre_release_suffix_is_lenient() -> None:
    assert _cobre_python_supports_output("0.16.0rc1") is True
